...
if(USE_CUDA)
    ...
    # endif()
    if(USE_CUMETAL)
        # CuMetal.cmake defines the CUDA::* targets FindCUDAToolkit would otherwise provide.
        include(${CMAKE_CURRENT_LIST_DIR}/CuMetal.cmake)
    else()
    ...
    if(USE_CUMETAL)
        message(STATUS "Using CuMetal at ${CUMETAL_ROOT} (CUDA device code targets the Apple GPU)")
    else()
