...
class RGBDOdometry : public IVisualOdometry {
public:
  RGBDOdometry(const camera::Rig& rig, const camera::FrustumIntersectionGraph& fig, const Settings& settings,
               bool use_gpu);
...
private:
  pipelines::SolverSfMRGBD solver_;
  ...
  // profiler
  profiler::VioProfiler::DomainHelper profiler_domain_ = profiler::VioProfiler::DomainHelper("RGBD VO");
