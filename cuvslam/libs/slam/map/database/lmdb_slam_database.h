...
protected:
  ...
  public:
    ...
    bool Put(MDB_dbi dbi, const Key& key, const Blob& blob);
    bool Put(MDB_dbi dbi, MDB_val* key, MDB_val* data);
    bool Del(MDB_dbi dbi, const Key& key);
  ...
  public:
    ...
    bool Get(Key& key, Blob& blob);
    bool Get(Key& key, MDB_val& data);
  ...
  public:
    ...
    bool Get(MDB_dbi dbi, const Key& key, Blob& blob);
    bool Get(MDB_dbi dbi, const Key& key, MDB_val& data);
