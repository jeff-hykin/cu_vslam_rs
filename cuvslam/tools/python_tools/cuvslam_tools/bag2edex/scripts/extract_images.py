...
The generated dataset contains images and a partial EDEX metadata file with only intrinsics.
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=pathlib.Path,
        required=True,
        help="Path where the image dataset is generated.",
    )
