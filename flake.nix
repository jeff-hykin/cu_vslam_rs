{
  description = "cu_vslam_rs: Rust FFI for NVIDIA cuVSLAM, with per-platform SDK packages built from the vendored fork in cuvslam/";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      let
        ...
        sdkFor = name: sdk: pkgs.stdenv.mkDerivation {
          ...
          buildInputs = [ pkgs.stdenv.cc.cc.lib ] ++ cudaLibs sdk;
          installPhase = ''
            runHook preInstall
